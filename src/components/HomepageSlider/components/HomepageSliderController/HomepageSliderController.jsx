...
export const HomepageSliderController = ({
  images,
  activeSlideId,
  onSwiperSlide,
  ...restProps
  ...
  return (
    <div className="swiper-controller__grid grid">
      <div className="swiper-controller__wrapper">
        <Swiper
          {...swiperConfig}
          onSwiper={setSwiper}
          className="swiper-controller"
          onActiveIndexChange={(swiper) => onSwiperSlide(swiper.realIndex || 0)}
          {...restProps}
        >
          {images.map(({ id, slug }) => (
            <SwiperSlide
            ...
            >
              <Image
                src={getS3ImageUrl(slug, 105)}
                //TODO: remove this alt
                alt="alt"
                style={{
                  objectFit: 'cover',
                }}
                width={248}
                height={105}
                className="swiper-controller__image"
              />
            </SwiperSlide>
          ))}
        ...
        <Button 
          ...
          className="swiper-controller__button secondary-button"
          isIconOnly
          disableAnimation
          startContent={
        ...
        <Button 
          onClick={handleNext}
          className="swiper-controller__button swiper-controller__button-next secondary-button"
          isIconOnly
          disableAnimation
          startContent={
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
