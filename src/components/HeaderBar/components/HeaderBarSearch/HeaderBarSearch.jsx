...
import HeaderBarSearchPreview from '../HeaderBarSearchPreview/HeaderBarSearchPreview';
...
export const HeaderBarSearch = ({ 
  ...
  }, [searchRef, handleCloseInput]);

  return (
    <div className="header-bar__search-wrapper" ref={searchRef}>
      <Input
        className={cn("header-bar__search input", {
          "show-from-tablet": isShouldBeShownFromTablet
        })}
        type="text"
        isClearable
        autoFocus
      ...
      {(searchValue && value) && (
        <HeaderBarSearchPreview
          searchValue={searchValue}
          handleLinkOnClick={() => setValue('')}
        />
      )}
    </div>
  )
